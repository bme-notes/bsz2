...
%\end{leftbar}
\begin{shaded}
ÖSSZEFÜGGŐSÉG Definíció: $K \subseteq V(G)$ (összefüggő) \textbf{komponense} G-nek, ha minden $u,v \in K$ esetén bármely u és v között létezik út, viszont ha $v \in V(G)\backslash K$, akkor u és v között NEM létezik út. Ha a komponensek száma 1, vagyik ha G bármely két pontja között vezet út, akkor a G gráf \textbf{összefüggő}.
\end{shaded}
\begin{shaded}
