...
\pagestyle{fancy}
\hyphenpenalty=10000 % Sajnos nem sikerült megoldani a magyar elválasztást, ezért egyszerűen kikapcsoltam :( (no persze fél óra szenvedés után :@)
...
\newenvironment{bizonyitas}[1]{\begin{leftbar}\noindent\ignorespaces\textbf{\large Bizonyítás: #1}\normalsize\\}{\hfill$\square$\end{leftbar}\ignorespacesafterend}

\lstset{breaklines=true,postbreak=\mbox{\textcolor{red}{$\hookrightarrow$}\space},basicstyle=\small}
